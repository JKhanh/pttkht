...
<%@ page import="com.bookstore.db.BookDB, com.bookstore.db.ReviewDB, com.bookstore.models.review.Review, java.text.*" %>
<jsp:useBean id="book" scope="request" class="com.bookstore.models.book.Book"></jsp:useBean>
