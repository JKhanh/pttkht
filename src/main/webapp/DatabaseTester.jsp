...
<jsp:useBean id="user" scope="request" class="com.bookstore.models.user.User"></jsp:useBean>
<jsp:useBean id="users" scope="session" class="java.util.ArrayList"></jsp:useBean>
<jsp:useBean id="book" scope="session" class="com.bookstore.models.book.Book"></jsp:useBean>
